...
export default function NavigationPanel({
  ...
  const getDirectionIcon = (instruction: string) => {
    if (instruction.includes("right")) {
      return instruction.includes("slight") ? (
  ...
  return (
    <div
      className={`bg-white rounded-lg shadow-lg p-4 max-h-[80vh] overflow-y-auto transition-opacity duration-300 ${
    ...
    >
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <p className="text-sm text-green-600">
                This shelter is located outside the flood risk zone.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-4 p-3 bg-yellow-50 rounded-lg border border-yellow-100">
          <ul className="text-sm text-yellow-700 space-y-2">
            <li className="flex items-start gap-2">
              ...
              <span>
                This route avoids known flood zones and blocked roads where
                possible.
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-yellow-500 mt-1">•</span>
              <span>
                Road conditions may change rapidly during flooding. Stay alert
                for new hazards.
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-yellow-500 mt-1">•</span>
              <span>
                Never drive through flooded roads. Just 6 inches of water can
            ...
            <li className="flex items-start gap-2">
              <span className="text-yellow-500 mt-1">•</span>
              <span>
                If you encounter a flooded area, turn around and find an
                alternative route.
              </span>
            </li>
          </ul>
      ...
      <div className="mt-4 pt-3 border-t">
        <p className="text-xs text-gray-500">
          Navigation data provided by OpenStreetMap. Routes are calculated to
          avoid flood zones and blocked roads when possible.
        </p>
      </div>
    </div>
  );
