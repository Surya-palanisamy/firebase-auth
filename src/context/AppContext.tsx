...
export const AppProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  // Load mock data on mount (Firestore listeners would be added here when Firebase is configured)
  useEffect(() => {
    loadMockData()
    getUserLocation()
  }, [])
  ...
  useEffect(() => {
    ...
    return () => {
      // All listeners should be cleaned up here when implemented
      // Example: unsubscribeVolunteers?.()
    }
  }, [])
